...
const projetsData: Record<string, {
  ...
  "infra-teletravail-vpn": {
    ...
    outils: ["Stormshield SSL VPN", "Debian Linux", "xRDP", "VLAN", "Windows RDP", "Pare-feu Stormshield", "Virtualisation"],
    resultats: [
    ...
    competences: ["Architecture réseau", "VPN (Stormshield SSL VPN)", "Segmentation VLAN", "Pare-feu", "Administration Linux (Debian)", "RDP / xRDP", "NAT & routage", "Virtualisation"],
  },
  "infra-pme-ad-glpi": {
    ...
    architecture: [
      ...
      "1 serveur GLPI pour la gestion des tickets et l'inventaire",
    ...
    outils: ["Windows Server", "Active Directory (AD DS)", "GLPI", "GLPI Inventory", "Apache / PHP", "LDAP", "DNS / DHCP"],
    resultats: [
    ...
    competences: ["Active Directory", "GLPI Administration", "LDAP / Synchronisation", "Gestion de parc (GLPI Inventory)", "Administration Linux", "Ticketing & Support", "Windows Server"],
  },
};
