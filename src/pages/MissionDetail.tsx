...
const missionsData: Record<string, {
  ...
  "infrastructure-reseau": {
    ...
    competences: ["Câblage et brassage", "Configuration réseau (VLAN, routage)", "Ubiquiti UniFi", "Documentation réseau"],
  },
  "antivirus-kaspersky": {
  ...
  "active-directory": {
    ...
    actions: [
      ...
      "Création de scripts PowerShell pour automatiser les tâches récurrentes (création en masse de comptes ...)",
    ],
  ...
  "developpement-automatisation": {
    ...
    competences: ["Scripting Python", "Déploiement d'applications"],
  },
